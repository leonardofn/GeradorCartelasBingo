  ...
  Widget build(BuildContext context) {
    return Scaffold(
              ...
              itemBuilder: (context, index){
                ...
                return Card(
                  child: ListTile(
                    ...
                    trailing: Row(
                      // Ocupa o mínimo de espaço disponível
                      mainAxisSize: MainAxisSize.min,
                      children: <Widget>[
                        GestureDetector(
                          onTap: (){
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: (){
          _exibirTelaCadastro();
          var hk = MediaQuery.of(context).viewInsets.bottom;]
          print("Sfassssfssffffffffffffffffffffffffffffffff" + hk.toString());
        }
      ),
    );
  }
